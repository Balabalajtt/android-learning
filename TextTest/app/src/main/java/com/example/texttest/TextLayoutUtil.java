...
class TextLayoutUtil {
    ...
    private static final String TAG = "TextLayoutUtil";
    ...
    public static int getPreciseOffset(TextView textView, int x, int y) {
        ...
        if (layout != null) {
            ...
            Log.d(TAG, "getPreciseOffset: " + "line: " + line);
            Log.d(TAG, "getPreciseOffset: " + "offset" + offset);
            Log.d(TAG, "getPreciseOffset: " + "offsetX" + offsetX);
            if (offsetX > x) {
